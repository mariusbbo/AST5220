...
class RecombinationHistory{
  private:
    ...
    Spline Xe_spline_peebles{ "Xe_peebles" };
    Spline dtaudx_spline{ "dtaudx" };
    Spline T_of_x_spline{ "T" };
    Spline kB_T_of_x_spline{ "kB_T" };
  ...
  public:
    ...
    void info() const;
    void output_times(const std::string filename_times) const;
    ...
    void create_Xe_of_x_saha_and_T_spline();
