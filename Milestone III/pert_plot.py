...
# # plt.vlines(-7.162, ymin=phi[0].min(), ymax=phi[0].max(), color="k", ls="dotted", label=r"Rec. half-way")
...
# # plt.vlines(-7.162, ymin=2e-3, ymax=delta_cdm[0].max(), color="k", ls="dotted", label=r"Rec. half-way")
# plt.vlines(-6.988, ymin=2e-3, ymax=delta_cdm[0].max(), color="k", ls="--", label=r"Decoupling")
# # plt.title(r"Matter density perturbations")
# plt.title(r"Density perturbations")
# plt.xlabel("x")
# # plt.ylabel(r"$\delta_{\rm CDM}$ (solid),  |$\delta_{\rm b}$| (dashed)")
...
# # plt.savefig("Images/delta_m.pdf")
...
# plt.vlines(-7.162, ymin=v_cdm[2].min(), ymax=v_cdm[0].max(), color="k", ls="dotted", label=r"Rec. half-way")
plt.vlines(-6.988, ymin=v_cdm[2].min(), ymax=v_cdm[0].max(), color="k", ls="--", label=r"Decoupling")
# plt.title(r"Matter velocity perturbations")
plt.title(r"Velocity perturbations, matter")
plt.xlabel("x")
# plt.ylabel(r"$v_{CDM}$ (solid),  |$v_b$| (dashed)")
...
# plt.savefig("Images/v_m_and_gamma_new.pdf")
plt.show()
